            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center w-full max-w-md mx-auto">
              {isAuth ? (
                <div className="flex flex-col items-center">
                  ...
                  <Link href="/dashboard">
                    <span className="inline-flex items-center px-6 py-3 sm:px-8 sm:py-4 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-xl transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl cursor-pointer w-full sm:w-auto text-center justify-center">
                      Go to Dashboard
                    </span>
                  </Link>
                  <button
                ...
                <div className="flex flex-col sm:flex-row gap-4 w-full">
                  <Link href="/auth/login" className="w-full sm:w-auto">
                    <span className="inline-flex items-center justify-center px-6 py-3 sm:px-8 sm:py-4 bg-white hover:bg-gray-50 text-blue-600 font-semibold rounded-xl transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl border border-gray-200 cursor-pointer w-full text-center">
                  ...
                  <Link href="/auth/signup" className="w-full sm:w-auto">
                    <span className="inline-flex items-center justify-center px-6 py-3 sm:px-8 sm:py-4 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-semibold rounded-xl transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl cursor-pointer w-full text-center">
                      <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
